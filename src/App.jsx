...
function App() {
  ...
  return (
    ...
    <h3>O que é o feminicídio?</h3>
    <p>Feminicídio é um termo de crime de ódio baseado no gênero, mais definido como o assassinato de mulheres em violência doméstica ou em aversão ao gênero da vítima, mas as definições variam dependendo do contexto cultural.</p>
    </div>
    ...
    <div className='container4'>
      <h3>Diferença no numero de vitimas pela cor de pele</h3>
    ...
    <h3>Municipios com maior numerode de vitimas</h3>
            ...
            <img src="https://cdn.discordapp.com/attachments/568273480303378433/1121258129024372896/Mapa-2.jpg" alt="" />
    </div>
